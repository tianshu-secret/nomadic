...
Dialog.prototype = {
	...
	setPosition : function( elem, fixed ){
		...
		if( fixed ){
			if( isIE6 ){
				style.setExpression( 'top','fuckIE6=document.documentElement.scrollTop+document.documentElement.clientHeight/5+"px"' );
			}
			else{
				style.top = '40%';
			}
	...
	createOverlay : function(){
		...
		style.cssText = 'margin:0;padding:0;border:none;width:100%;height:100%;background:#333;opacity:0.6;filter:alpha(opacity=60);z-index:9000;position:fixed;top:0;left:0;';
